...
<div id="register" class="well my-popup" style="max-width:44em;">
    <h4>Register</h4>
        <?php echo form_open(base_url('login_control/register') ,'role="form" class="form-horizontal"'); ?>
          ...
          <div class="popup-form">
            <div class="col-xs-12">
                <?php echo form_input('user_name', '', 'placeholder="Full Names *" class="form-control" required="required"') ?>
            </div>
            <div class="col-xs-12">
            ...
            <div class="col-xs-12">
                <?php echo form_password('user_pass', '', 'placeholder="Password (Minimum 8 character) *" class="form-control" required="required"') ?>
            </div>
            <div class="col-xs-12">
