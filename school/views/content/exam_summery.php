...
<div class="container">
    ...
    <ol class="breadcrumb hidden-print">
        ...
        <li class="active">Exam Summary</li>
    </ol>
</div>
<div class="container">
    <div class="col-md-12">
...
<div class="container">
    <div class="col-md-6">
        <div class="panel panel-primary">
            <div class="panel-heading">Exam Summary:</div>        
...
?>
<div class="container">
    <a href="<?=base_url('exam_control/'.$payment_info.'/'.$mock->title_id) ?>" class="btn btn-primary col-xs-5 col-xs-offset-1"> <?php echo ($payment_info == 'payment_process')?'Pay with PayPal':'Start Exam' ?></a>    
