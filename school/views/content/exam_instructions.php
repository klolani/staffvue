<div class="container">
    ...
    <ol class="breadcrumb hidden-print">
        ...
        <li><a href="<?=base_url('exam_control/view_exam_summery/' . $mock->title_id) ?>"><i class="fa fa-tasks"></i> Exam Summary</a></li> 
...
<div class="container">
    ...
    <div class="col-md-12">
        ...
        <div class="well well-sm">
            <ul>
                <li>This exam has only 2 attempts limit. Once exceeded, you cannot retake the exam.</li>
				<li>Each question has between 2 and 4 options. You have to choose one or more correct answers.</li>
                ...
                <li>There is no partial marking! If any question have more than one correct answers, you have to mark all correct answers </li>
                <li>Unanswered questions will be count as wrong answers.</li>
                <li>You must answer all questions before the time duration shown at the top.</li>
                <li>You cannot resume the exam.</li>
            </ul>
        </div>
    </div>
</div><br/><br/>
<div class="container">
    <a href="<?=base_url('exam_control/start_exam/'.$mock->title_id) ?>" id="start-exam" class="btn btn-lg btn-primary col-xs-5 col-xs-offset-1">Start Exam</a>    
