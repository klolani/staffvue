    ...
    <h1 class="text-center">Install | Minor School</h1>
        ...
        <fieldset class="set-border">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" id="hostname" value="" class="form-control" name="hostname"  placeholder="Hostname" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" id="database" value="" class="form-control" name="database"  placeholder="Database Name" />
                </div>
            </div><br/>
