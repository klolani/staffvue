                            ...
                            ?>
                                <tr class="<?= ($i & 1) ? 'even' : 'odd'; ?>">
                                    <td>
                                        ...
                                        <?= $this->session->userdata('currency_code') . ' ' . $this->session->userdata('currency_symbol') ?><a href="#" data-name="exam_price" data-type="text" data-url="<?php echo base_url('admin_control/update_mock_title'); ?>" data-pk="<?= $mock->title_id; ?>" class="data-modify-<?= $mock->title_id; ?> no-style"><?= $mock->exam_price; ?></a>
