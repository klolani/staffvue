...
<form id="anserForm" action="<?= base_url('exam_control'); ?>" method="post">
    ...
    <div class="container me-control-btn">
        <a class="btn btn-lg btn-primary col-xs-5 col-xs-offset-0 me-prev" href="#Carousel" data-slide="next" disabled> &laquo; Prev<span class="hidden-xxs">ious Question</span></a>
        <a class="btn btn-lg btn-primary col-xs-5 col-xs-offset-2 me-next" href="#Carousel" data-slide="prev"> Next <span class="hidden-xxs">Question</span> &raquo; </a>
    </div>
