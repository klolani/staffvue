...
<div class="block">  
    <div class="navbar block-inner block-header">
        <div class="row">
            ...
            ?>
                <a class="btn custom_navbar-btn btn-primary pull-right col-sm-3" href="<?php echo base_url('admin_control/add_more_question') . '/' . $mock_title->title_id; ?>"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp; Add More Question</a>
            <?php 
            } ?>
            </p>
        </div>
                            ...
                            foreach ($mock_ans[$mock->ques_id] as $all_ans) {
                                ...
                                foreach ($all_ans as $ans) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" data-name="ans-text" data-type="textarea" data-rows="2" data-url="<?php echo base_url('admin_control/update_answer/'.$mock->ques_id); ?>" data-pk="<?=$ans->ans_id; ?>" class="data-modify-<?=$ans->ans_id; ?> no-style"><?=form_prep($ans->answer); ?></a>
                                        </td>
                                        <td>
